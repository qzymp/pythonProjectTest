...
#gamelabel_list = ["all","1","2","3-30","30-600"]
# gamelabel_list = ['领取体力','all']
# gamelabel_list = ['第一关','第二关','第三关','第四关','第五关']
gamelabel_list = ["all"]
#gamelabel_list = ["1","2","3","4","5","all"]
# gamelabel_list = ['第1波','第2波','第3波','第4波','第5波','第6波','第7波','第8波','第9波','第10波','第11波','第12波','第13波','第14波','第15波','第16波']

# gamelabel_list = ["贵族主页","贵族主页-成长体系","贵族主页-VIP10","贵族主页-积分榜","贵族主页-首充","贵族主页-贵族好礼","贵族主页-贵族好礼-春节之礼","贵族主页-贵族特权","贵族主页-账号传承-传承+号"]
# gamelabel_list = ["大厅界面无灵宝","个人主页-无灵宝","邀请界面-无灵宝","大厅孵化灵宝后","个人主页-有灵宝","养成界面-主页","养成界面-主页-详情","养成界面-主页-道具"]
# gamelabel_list = ['空场景','','低等怪帧率极限前','低等怪帧率极限值','中等怪帧率极限前','中等怪帧率极限值','高等怪帧率极限前','高等怪帧率极限值',
#                   '低等特效帧率极限前','低等特效帧率极限值','中特效帧率极限前','中特效帧率极限值','高特效帧率极限前','高特效帧率极限值']
# gamelabel_list = ['低等怪CPU极限前','低等怪CPU极限值','中等怪CPU极限前','中等怪CPU极限值','高等怪CPU极限前','高等怪CPU极限值',
#                   '低等特效CPU极限前','低等特效CPU极限值','中等特效CPU极限前','中等特效CPU极限值','高等特效CPU极限前','高等特效CPU极限值']
...
if __name__ == '__main__':
    # 常规数据 + 功耗数据 获取
    catch_routineperfdog_data("D:\\aov\\0201")
    # ui数据获取
